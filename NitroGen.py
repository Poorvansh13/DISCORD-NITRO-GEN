...
import time
LICNECE = """
Copyright (c) 2025 Worthy Earbudfn@gmail.com

Loading Generator... Please Wait."""
    ...
    def main(self):  # The main function contains the most important code
        ...
        if os.name == "nt":  # If the system is windows
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Generator and Checker - Made by worthy")  # Change the
 ...
 \ \ /\ / / _ \| '__| __| '_ \| | | |
  \ V  V / (_) | |  | |_| | | | |_| |
   \_/\_/ \___/|_|   \__|_| |_|\__, |
        ...
        self.slowType("Made by: Worthy", .02)
        ...
        for s in c:  # Loop over the amount of codes to check
            ...
            if os.name == "nt":  # If the system is windows
                ctypes.windll.kernel32.SetConsoleTitleW(
                    f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by Worthy")  # Change the title
                print("")
            else:  # If it is a unix system
                # Change the title
                print(
                    f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Made by worthy\a', end='', flush=True)
